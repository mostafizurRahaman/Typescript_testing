...
let age: number; // only allows  number not string , boolean or null or undefined or any types
age = 2;
...
let myFatherAge: string | number | boolean; // the variable allows three types of data now because we define the variable types are string , number , boolean ;
...
let isSister: string | number | boolean; 
isSister  = 'two'; 
isSister = 2; 
isSister = true; 
